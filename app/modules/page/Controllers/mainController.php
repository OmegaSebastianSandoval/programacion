...
class Page_mainController extends Controllers_Abstract
{
	...
	public function init()
	{
		...
		$popUp = $publicidadModel->getList("publicidad_seccion='101' AND publicidad_estado='1'", "orden ASC")[0];
		$this->_view->popUp = $popUp;
		$flotantes = $publicidadModel->getList("publicidad_seccion='100' AND publicidad_estado='1'", "orden ASC");
		$this->_view->flotantes = $flotantes;
