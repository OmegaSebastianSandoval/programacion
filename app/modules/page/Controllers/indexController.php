...
class Page_indexController extends Page_mainController
{
  ...
  public function indexAction()
  {
    ...
    foreach ($eventosRaw as $key => $ev) {
      $dateKey = substr($ev->evento_fecha, 0, 10);
      $timeStr = substr($ev->evento_fecha, 11, 5);
      $eventoId = $ev->evento_id;
      $boletas = $boletasEventosModel->getList("boleta_evento_evento = '$eventoId' AND boleta_evento_fechalimite >= '$fechaActual'", "");
    ...
    $this->_view->programacion = $programacion;
