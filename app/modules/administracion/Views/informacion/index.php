<div class="container-fluid">
  <form enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>">
      ...
      <div align="center" class="pading-dashboard">
        ...
        <div class="row">
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-facebook"><i class="fa-brands fa-facebook-f"></i></span>
              </div>
          ...
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-instagram"><i class="fa-brands fa-instagram"></i></span>
              </div>
              <input type="url" value="<?= $this->content->info_pagina_instagram; ?>" name="info_pagina_instagram" id="info_pagina_instagram" class="form-control">
            </div>
          </div>
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-twitter"><i class="fa-brands fa-x-twitter"></i></span>
              </div>
              <input type="url" value="<?= $this->content->info_pagina_x; ?>" name="info_pagina_x" id="info_pagina_x" class="form-control">
            </div>
          </div>
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-pinterest"><i class="fa-brands fa-pinterest-p"></i></span>
              </div>
              <input type="url" value="<?= $this->content->info_pagina_pinterest; ?>" name="info_pagina_pinterest" id="info_pagina_pinterest" class="form-control">
            </div>
          </div>
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-youtube"><i class="fa-brands fa-youtube"></i></span>
              </div>
              <input type="url" value="<?= $this->content->info_pagina_youtube; ?>" name="info_pagina_youtube" id="info_pagina_youtube" class="form-control">
            </div>
          </div>
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-flickr"><i class="fa-brands fa-tiktok"></i></span>
              </div>
          ...
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-linkedin"><i class="fa-brands fa-linkedin-in"></i></span>
              </div>
          ...
          <div class="col-6 form-group mb-2">
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono fondo-whatsapp"><i class="fa-brands fa-whatsapp"></i></span>
              </div>
              <input type="number" value="<?= $this->content->info_pagina_whatsapp; ?>" name="info_pagina_whatsapp" id="info_pagina_whatsapp" class="form-control">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row justify-content-start">
      <div class="col-4" style="overflow: hidden;">
        <div class="div-dashboard h-100">
          ...
          <h2>
            <i class="fa-brands fa-fonticons"></i> Favicon
          </h2>
          <div align="center" class="pading-dashboard">
            <br>
            <div class="row">
      ...
      <div class="pading-dashboard">
        <div class="row">
          ...
          <div class="col-4 form-group">
            ...
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono-grande fondo-tags"><i class="fa-solid fa-tags"></i></span>
              </div>
      ...
      <div class="pading-dashboard">
        <div class="row">
          <div class="col-12 form-group">
            ...
            <div class="input-group">
              <div class="input-group-prepend ">
                <span class="input-group-text input-icono-grande fondo-scripts"><i class="fa-solid fa-code"></i></span>
              </div>
