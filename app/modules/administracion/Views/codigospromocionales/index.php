			...
			<div class="row">
				...
				<div class="col-2 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="porcentaje"
							value="<?php echo $this->getObjectVariable($this->filters, 'porcentaje') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Evento</label>
					<label class="input-group">
						...
						<select class="form-control" name="evento">
							...
							<?php foreach ($this->list_evento as $key => $value): ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'evento') == $key) {
										echo "selected";
									} ?>><?= $value; ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-3 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="usado"
							value="<?php echo $this->getObjectVariable($this->filters, 'usado') ?>"></input>
					</label>
				</div>
				<div class="col-3  d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="fecha_uso"
							value="<?php echo $this->getObjectVariable($this->filters, 'fecha_uso') ?>"></input>
					</label>
				</div>
				<div class="col-2">
					<label>&nbsp;</label>
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<td><?= $this->list_evento[$content->evento]; ?>
							<td><?= $content->usado; ?></td>
