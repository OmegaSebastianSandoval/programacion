			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="noticia_fecha"
							value="<?php echo $this->getObjectVariable($this->filters, 'noticia_fecha') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Titulo</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="noticia_titulo"
							value="<?php echo $this->getObjectVariable($this->filters, 'noticia_titulo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
