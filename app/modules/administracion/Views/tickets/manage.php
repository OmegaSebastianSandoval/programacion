	...
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>"  data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-12 form-group">
					<label for="ticket_evento_id"  class="control-label">ticket_evento_id</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->ticket_evento_id; ?>" name="ticket_evento_id" id="ticket_evento_id" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					<label for="ticket_estado"  class="control-label">ticket_estado</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->ticket_estado; ?>" name="ticket_estado" id="ticket_estado" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
				...
				<div class="col-12 form-group">
					<label for="ticket_observaciones"  class="control-label">ticket_observaciones</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->ticket_observaciones; ?>" name="ticket_observaciones" id="ticket_observaciones" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
					<label for="ticket_usuario_validador"  class="control-label">ticket_usuario_validador</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->ticket_usuario_validador; ?>" name="ticket_usuario_validador" id="ticket_usuario_validador" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
			</div>
