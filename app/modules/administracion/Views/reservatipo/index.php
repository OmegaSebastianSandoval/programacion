        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="reserva_tipo_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'reserva_tipo_nombre') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->reserva_tipo_id; ?>
					<tr>
						<td><?=$content->reserva_tipo_nombre;?></td>
						<td class="text-end">
							<div>
