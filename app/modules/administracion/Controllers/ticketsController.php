<?php
/**
* Controlador de Tickets que permite la  creacion, edicion  y eliminacion de los Tickets del Sistema
*/
class Administracion_ticketsController extends Administracion_mainController
{
	/**
	 * $mainModel  instancia del modelo de  base de datos Tickets
	...
	/**
     * Recibe la informacion y  muestra un listado de  Tickets con sus respectivos filtros.
     *
     * @return void.
     */
	...
	/**
     * Inserta la informacion de un Ticket  y redirecciona al listado de Tickets.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un Ticket  y redirecciona al listado de Tickets.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un Ticket  y redirecciona al listado de Tickets.
     *
     * @return void.
     */
	...
	private function getData()
	{
		...
		$data['ticket_evento_id'] = $this->_getSanitizedParam("ticket_evento_id");
		...
		$data['ticket_usuario_validador'] = $this->_getSanitizedParam("ticket_usuario_validador");
		return $data;
	}
	/**
